...
| Ежедневный журнал | `log/okbswitch.<дата>.log` |
...
При сообщении о проблеме включите **«Подробный журнал (Debug)»** в разделе
«Устранение проблем». Изменение действует без перезапуска. В журнал попадают
события и решения детектора, а не набранный текст. По умолчанию Debug выключен.
